...
public class SubjectResourceIntTest {
    ...
    public void createSubject() throws Exception {
        ...
        assertThat(testSubject.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    }
    ...
    @Test
    @Transactional
    public void checkTotalHoursIsRequired() throws Exception {
        int databaseSizeBeforeTest = subjectRepository.findAll().size();
        // set the field null
        subject.setTotalHours(null);
    ...
    public void updateSubject() throws Exception {
        ...
        assertThat(testSubject.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
    }

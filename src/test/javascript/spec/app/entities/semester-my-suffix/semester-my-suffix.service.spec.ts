...
describe('Service Tests', () => {
    ...
    describe('SemesterMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SemesterMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return SemesterMySuffix', () => {

                let entity: SemesterMySuffix;
                service.find(123).subscribe((_entity: SemesterMySuffix) => {
                    entity = _entity;
                });

...
describe('Service Tests', () => {
    ...
    describe('WeekMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WeekMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/weeks';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WeekMySuffix', () => {

                let entity: WeekMySuffix;
                service.find(123).subscribe((_entity: WeekMySuffix) => {
                    entity = _entity;
                });

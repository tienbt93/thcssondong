...
@Injectable()
export class WeekMySuffixPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.weekService.find(id).subscribe((week) => {
                    this.ngbModalRef = this.weekModalRef(component, week);
                    resolve(this.ngbModalRef);
                });
            } else {
                // setTimeout used as a workaround for getting ExpressionChangedAfterItHasBeenCheckedError
                setTimeout(() => {
                    this.ngbModalRef = this.weekModalRef(component, new WeekMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    weekModalRef(component: Component, week: WeekMySuffix): NgbModalRef {
